...
基于 Rust 开发的**实验性** RISC-V 操作系统，实现了动态内存管理、结构清晰的系统调用架构、**嵌入式 ext4 文件系统**，以及 **ELF 程序执行能力**。非常适合**学习**、**研究**和**教育用途**。
...
elinKernel> ext4check               # 检查嵌入式 ext4 文件系统
elinKernel> disktest                # 测试文件系统操作
